...
PROMPT="
%K{magenta}%F{black} %n@%m %k%f%F{magenta}%K{blue}"$'\u2b80'"%k%f%F{white}%K{blue} %~% "$'$(git_prompt_info)'" %k%f%F{blue}"$'\u2b80'"%f
%k%F{white}"$'\u2b80'"%f "

#PROMPT=$POWERLINE_COLOR_FG_WHITE$'\u2b82'"%f$POWERLINE_COLOR_BG_WHITE $POWERLINE_COLOR_FG_GRAY$POWERLINE_RIGHT_B "$'\u2b82'"%f%k$POWERLINE_COLOR_BG_GRAY$POWERLINE_COLOR_FG_WHITE $POWERLINE_RIGHT_A %f%k"
